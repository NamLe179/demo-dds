...
This example was generated for architecture x64Linux4gcc8.5.0, using the
data type ObjectState from ObjectState.idl.
This example builds two applications, named ObjectState_publisher and
ObjectState_subscriber.

Simple Example
============
This example is generated with the following options:
...
> make -f makefile_ObjectState_x64Linux4gcc8.5.0
This command will build a release executable.
 
To build a debug version instead:
> make -f makefile_ObjectState_x64Linux4gcc8.5.0 DEBUG=1

To Modify the Data:
===================
To modify the data being sent, edit the ObjectState_publisher.cxx
file where it says:
...
Run /opt/rti.com/rti_connext_dds-7.7.0/resource/scripts/rtisetenv_x64Linux4gcc8.5.0.bash
...
> objs/x64Linux4gcc8.5.0/ObjectState_publisher -d <domain_id> -s <sample_count>
> objs/x64Linux4gcc8.5.0/ObjectState_subscriber -d <domain_id> -s <sample_count>
